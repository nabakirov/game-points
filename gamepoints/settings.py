"""
Django settings for gamepoints project.
...
WSGI_APPLICATION = 'gamepoints.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'gamepoints.views.exception_handler',
